...
#' nobs
#'
#' Generic method to return the size of the data
#'
...
#' Print GLM family
#'
#' Generic method to return the family of the GLM
#'
#' @param x a \code{dpGLM} object returned by the function
#'          \code{hdpGLM}
#' @param ... ignore 
...
#' Generic method to return the family of the GLM
#'
#' @param x a \code{ndpGLM} object returned by the function
#'          \code{hdpGLM}
#' @param ... ignore 
#'
#'
#' @export
family.hdpGLM = function(x, ...)
{
    cat("\n\n")
    return(attr(x, 'family'))
    invisible()

...
## }}}
hdpGLM_simulateData <- function(n, K, nCov=2, nCovj=0, J=1, family='gaussian', parameters=NULL, pi=NULL, same.K=FALSE , seed=NULL , context.effect=NULL , same.clusters.across.contexts=NULL , context.dependent.cluster=NULL)
{
